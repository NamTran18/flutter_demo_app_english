...
// packages này để ramdom ra các câu word
...
class Quotes {
  ...
  Quote? getByWord(String word) {
    ...
    Random ran = Random();
    return quotes.isEmpty ? null : quotes[ran.nextInt(quotes.length)]; // kiểm tra có pahir 1 xâu rỗng hay ko
  }
